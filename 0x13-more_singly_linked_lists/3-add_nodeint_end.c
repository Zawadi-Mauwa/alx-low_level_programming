#include "lists.h"
/**
 * add_nodeint_end - Will add new node at end of a listint_t list
 *
 * @head: 1st param is pointer to pointer of first element of list
 *
 * @n: 2nd paran & is an  element to be added in the list
 *
